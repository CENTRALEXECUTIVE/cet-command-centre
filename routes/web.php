...
Route::middleware(['auth', \App\Http\Middleware\RequirePasswordChange::class])->group(function () {
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('bookings/{booking}/extra-drivers/passengers', [BookingController::class, 'setExtraDriverPassengers'])->middleware('throttle:60,1')->name('bookings.extra-drivers.passengers');
        ...
        Route::post('bookings/{booking}/settled', [BookingController::class, 'setSettled'])->middleware('throttle:30,1')->name('bookings.settled');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        // Call-only test: ring the business line to confirm the emergency line works.
        Route::post('settings/notifications/test-call', [\App\Http\Controllers\Admin\NotificationPreferencesController::class, 'testCall'])->middleware('throttle:6,1')->name('notifications.test-call');
...
Route::post('job/{token}/child-seats', [\App\Http\Controllers\Driver\LinkController::class, 'confirmChildSeats'])
...
Route::post('car/{token}/child-seats', [\App\Http\Controllers\Driver\ExtraDriverController::class, 'confirmChildSeats'])
    ->middleware('throttle:60,1')->name('driver.car.child-seats');
Route::post('car/{token}/notes-ack', [\App\Http\Controllers\Driver\ExtraDriverController::class, 'confirmNotes'])
    ->middleware('throttle:60,1')->name('driver.car.notes-ack');
