...
class VehicleTypeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $types = [
            // Capacities mirror ETO's "Types of Vehicles" (passengers + luggage).
            ['name' => 'Executive',        'slug' => 'executive',     'passenger_capacity' => 4,  'luggage_capacity' => 2, 'affects_rotation' => true,  'uses_third_party_driver' => false, 'sort_order' => 1],
            ...
            ['name' => 'Minibus 8 Seater', 'slug' => 'minibus-8',     'passenger_capacity' => 7,  'luggage_capacity' => 5, 'affects_rotation' => false, 'uses_third_party_driver' => true,  'sort_order' => 4],
            ['name' => 'Minibus 8 XL',     'slug' => 'minibus-8-xl',  'passenger_capacity' => 8,  'luggage_capacity' => 8, 'affects_rotation' => false, 'uses_third_party_driver' => true,  'sort_order' => 5],
